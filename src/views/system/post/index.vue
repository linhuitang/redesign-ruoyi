<template>
   <div class="app-container">
      ...
      <el-table v-loading="loading" :data="postList" @selection-change="handleSelectionChange" :height="tableHeight" ref="tableRef">
...
function getAutoHeight() {
  if (tableRef.value && tableRef.value.$el) {
    ...
    const paddingBottom = 24 + 50 + 20; // Pagination height included
