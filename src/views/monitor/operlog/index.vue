<template>
   <div class="app-container">
      ...
      <el-table ref="operlogRef" v-loading="loading" :data="operlogList" @selection-change="handleSelectionChange" :default-sort="defaultSort" @sort-change="handleSortChange" :height="tableHeight"
      >
...
function getAutoHeight() {
  if (operlogRef.value && operlogRef.value.$el) {
    const windowHeight = window.innerHeight;
    const tableTop = operlogRef.value.$el.getBoundingClientRect().top;
