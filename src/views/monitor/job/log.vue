...
import { getCurrentInstance, ref, reactive, toRefs, onMounted, nextTick, onBeforeUnmount, watch } from 'vue'
...
function handleDelete(row) {
  ...
  proxy.$modal.confirm('是否确认删除调度日志编号为"' + jobLogIds + '"的数据项?').then(function () {
