      ...
      <el-scrollbar class="left-scrollbar">
        <div class="components-list">
          <div class="components-title">
            <svg-icon icon-class="Notification" />输入型组件
          </div>
          <draggable class="components-draggable" :list="inputComponents"
            :group="{ name: 'componentsGroup', pull: 'clone', put: false }" :clone="cloneComponent"
            draggable=".components-item" :sort="false" @end="onEnd" item-key="tagIcon">
          ...
          <div class="components-title">
            <svg-icon icon-class="Filter" />选择型组件
          </div>
          ...
          <div class="components-title">
            <svg-icon icon-class="Document" /> 布局型组件
          </div>
...
import { onMounted, watch, ref, getCurrentInstance, nextTick, onUnmounted } from 'vue'
