...
export function getUser(userId) {
  return request('/system/user/' + parseStrEmpty(userId), {
    method: 'get'
  })
}
...
export function uploadAvatar(data) {
  return request('/system/user/profile/avatar', {
    method: 'post',
    // headers: { 'Content-Type': 'application/x-www-form-urlencoded' }, // fetch handles FormData automatically if not set, check usage
    body: data 
  })
}
