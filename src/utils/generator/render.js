import { defineComponent, h, resolveComponent, withCtx } from 'vue'
...
export default defineComponent({
  ...
  render() {
    ...
    // 处理 default slot (children)
    // 使用 lazy generation + withCtx
    const childObjs = componentChild[confClone.tag]
    if (childObjs) {
      slot.default = withCtx(() => {
        const children = []
